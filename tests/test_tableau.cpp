...
void testTableau() {
    ...
    assert((tableau.getCell(0, 0).getValue() == 0) && "Failed: tableau.getCell(0, 0) != 0");
    assert((tableau.getCell(10, 10).getValue() == 0) && "Failed: tableau.getCell(10, 10) != 0"); // Out of bounds
    ...
    vector<vector<Case>> newTab(10, vector<Case>(10, 1));
    tableau.setTab(newTab);
    assert((tableau.getCell(0, 0).getValue() == 1) && "Failed: tableau.getCell(0, 0) != 1");
    assert((tableau.getCell(9, 9).getValue() == 1) && "Failed: tableau.getCell(9, 9) != 1");
}
